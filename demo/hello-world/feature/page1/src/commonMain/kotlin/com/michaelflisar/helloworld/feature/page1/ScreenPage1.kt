package com.michaelflisar.helloworld.feature.page1
...
@Parcelize
object ScreenPage1 : NavScreen() {

    val title = Res.string.page_1
...
private fun Page() {
    Column(
        ...
        Text("Hello from ${stringResource(ScreenPage1.title)}!")
    }
}