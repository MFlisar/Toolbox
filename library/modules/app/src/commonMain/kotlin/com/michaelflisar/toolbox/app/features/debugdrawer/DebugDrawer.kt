...
import com.michaelflisar.toolbox.app.TODO
...
fun DebugDrawer(
    ...
    // Logging
    val fileLoggerSetup = setup.fileLoggerSetup
    if (showRegionLogging && fileLoggerSetup != null) {
    ...
    Dialog(
        ...
        PreferenceScreen(
            ...
            listOfNotNull(
                ...
                debugPrefs.showRegionLogging.takeIf { setup.fileLoggerSetup != null },
