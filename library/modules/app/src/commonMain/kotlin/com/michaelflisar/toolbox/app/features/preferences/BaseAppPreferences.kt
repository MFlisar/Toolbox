...
import com.michaelflisar.toolbox.app.resources.no
import com.michaelflisar.toolbox.app.resources.settings_change_language
import com.michaelflisar.toolbox.app.resources.settings_changelog
import com.michaelflisar.toolbox.app.resources.settings_dialog_attach_log_file_label
import com.michaelflisar.toolbox.app.resources.settings_dialog_attach_log_file_text
import com.michaelflisar.toolbox.app.resources.settings_feedback
import com.michaelflisar.toolbox.app.resources.settings_feedback_details
import com.michaelflisar.toolbox.app.resources.settings_group_about
import com.michaelflisar.toolbox.app.resources.settings_group_language
import com.michaelflisar.toolbox.app.resources.settings_group_others
import com.michaelflisar.toolbox.app.resources.settings_group_others_details
import com.michaelflisar.toolbox.app.resources.settings_group_privacy
import com.michaelflisar.toolbox.app.resources.settings_open_play_store
import com.michaelflisar.toolbox.app.resources.settings_open_play_store_details
import com.michaelflisar.toolbox.app.resources.settings_privacy_policy
import com.michaelflisar.toolbox.app.resources.settings_privacy_policy_details
import com.michaelflisar.toolbox.app.resources.yes
...
internal fun SettingsContent(
    ...
    PreferenceScreen(
        ...
        PreferenceSection(
            ...
            // --------------------
            /*
                        if (backup?.addToPrefs == true) {
                            backup.ContentPreferencesAsSubPreference(this)
                        }
            */
            // --------------------
            ...
            if ((Platform.sendFeedback != null && setup.fileLoggerSetup != null) || Platform.openMarket != null) {
                PreferenceSubScreen(
                    ...
                    PreferenceSection(
                        ...
                        if (Platform.sendFeedback != null && setup.fileLoggerSetup != null) {
                            PreferenceButton(
                                onClick = {
                                    if (L.isEnabled()) {
                                        showAttachLogFile.show()
                                    } else {
                                        Platform.sendFeedback?.invoke(false, setup.fileLoggerSetup)
                                    }
                                },
    ...
    if (showLogFile.value && setup.fileLoggerSetup != null) {
        LumberjackDialog(
            visible = showLogFile,
            title = "Log",
            setup = setup.fileLoggerSetup
        )
    }

    if (Platform.sendFeedback != null && setup.fileLoggerSetup != null && showAttachLogFile.visible) {
        DialogInfo(
            ...
            when (it) {
                is DialogEvent.Button -> {
                    when (it.button) {
                        DialogButtonType.Positive -> Platform.sendFeedback?.invoke(true, setup.fileLoggerSetup)
                        DialogButtonType.Negative -> Platform.sendFeedback?.invoke(false, setup.fileLoggerSetup)
                    }
                }
