package com.michaelflisar.toolbox.feature.infos
...
class InfoState internal constructor(
    ...
    companion object {
        fun create() = InfoState(mutableStateListOf())
    }
}
...
fun Infos(
    ...
    autoScroll: MutableState<Boolean> = remember { mutableStateOf(true) },
    infos: InfoState,
) {
