...
sealed class MenuItem {
     ...
     * - Alt+F
     *
     * The system modifier maps to the platform-specific system key
     * (e.g. Command on macOS, Windows/Super on Windows and Linux).
     */
    ...
    class Item internal constructor(
        ...
        val fallbackIcon: Painter?,
        val mnemonic: Char?,
        val keyboardShortcut: KeyboardShortcut?,
        val enabled: Boolean,
        val onClick: () -> Unit,
    ...
    companion object {
        ...
        fun item(
            ...
            return Item(
                text = text,
                icon = icon?.toIconComposable(),
                fallbackIcon = icon?.let { rememberVectorPainter(it) },
                mnemonic = mnemonic,
